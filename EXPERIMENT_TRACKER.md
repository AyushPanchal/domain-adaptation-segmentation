...
| E03 | Box-Guided Gray | YOLO11s-seg | RGB-box-gray | IR | Kaggle T4x2 | notebook ready | - | - | - | `notebooks/kaggle_one_experiment_e03_box_guided_gray.ipynb` | Box-level object-region grayscale baseline. Notebook generates box-guided gray EO train data under `/kaggle/working/generated/e03_box_guided_gray`; class `4: Ignore` remains unchanged. Eval uses `eval_ir` as primary and `eval_eo_ir` as secondary. |
