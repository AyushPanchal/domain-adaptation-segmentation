...
| E01 | Source RGB | YOLO11s-seg | RGB | IR | Kaggle T4x2 | completed | 2026-06-02 01:52 IST | 2026-06-02 02:32 IST | eval_ir: mask mAP50 0.2203, mask mAP50-95 0.0948, box mAP50 0.2362, box mAP50-95 0.1644; eval_eo_ir: mask mAP50 0.3386, mask mAP50-95 0.1669, box mAP50 0.3621, box mAP50-95 0.2603 | `downloads/full_e01_results.zip`; pending local download of `e01_bestpt_evaluations.zip` | Direct Kaggle dataset run, device=0,1, batch=16, workers=2. Early stopped at epoch 35/100; best epoch 10. Use `eval_ir` as primary domain-transfer metric and `eval_eo_ir` as secondary combined metric. |
