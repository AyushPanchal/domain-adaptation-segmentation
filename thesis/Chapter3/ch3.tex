...
\textbf{ID} & \textbf{Training Data} & \textbf{Model} & \textbf{Purpose} \\
\hline
E09 & EO+IR & YOLO11s-seg & Mixed-domain supervised baseline \\
N1 & IR & YOLO11s-seg & Target-domain supervised baseline \\
N2 & Balanced EO+IR & YOLO11s-seg & Controls EO/IR training ratio \\
\hline
\end{tabular}
\end{table}
...
\textbf{ID} & \textbf{Training Data} & \textbf{Model} & \textbf{Purpose} \\
\hline
E09 & EO+IR & YOLO11s-seg & Small mixed-domain reference \\
N3 & EO+IR & YOLO11l-seg & Large mixed-domain model \\
N1 & IR & YOLO11s-seg & Small IR-only reference \\
N4 & IR & YOLO11l-seg & Large IR specialist \\
\hline
\end{tabular}
\end{table}

This design allows two comparisons. First, E09 and N3 measure the effect of scaling for mixed-domain training. Second, N1 and N4 measure the effect of scaling for IR-only supervised training.
...
\hline
N3 & EO+IR & YOLO11l-seg & 640 \\
N7 & EO+IR & YOLO11l-seg & 960 \\
N8 & EO+IR & YOLO11x-seg & 960 \\
\hline
\end{tabular}
\end{table}

N7 isolates the effect of increasing resolution while keeping the model family at YOLO11l. N8 tests whether a larger YOLO11x model at the same high resolution improves further.
...
\hline
N6 & N3 + N4 & YOLO11l-seg + YOLO11l-seg & Generalist-specialist fusion \\
\hline
\end{tabular}
\end{table}
...
E09 & EO+IR & YOLO11s-seg & 640 & Mixed-domain baseline \\
N1 & IR & YOLO11s-seg & 640 & IR-only baseline \\
N2 & Balanced EO+IR & YOLO11s-seg & 640 & Data-ratio control \\
N3 & EO+IR & YOLO11l-seg & 640 & Large mixed-domain model \\
N4 & IR & YOLO11l-seg & 640 & Large IR specialist \\
N6 & N3+N4 ensemble & 2x YOLO11l-seg & 640 & Ensemble ablation \\
N7 & EO+IR & YOLO11l-seg & 960 & High-resolution model \\
N8 & EO+IR & YOLO11x-seg & 960 & XL high-resolution model \\
\hline
\end{tabular}
\end{table}
...
\begin{enumerate}
    ...
    \item Compare E01 with E09 to measure the impact of adding IR supervision.
    \item Compare E09, N1, and N2 to understand mixed-domain, target-domain, and balanced training.
    \item Compare E09 with N3 and N1 with N4 to study model scaling.
    \item Compare N3 and N7 to study high-resolution training.
    \item Compare N7 and N8 to study high-resolution model capacity.
    \item Compare N3, N4, and N6 to evaluate ensembling.
\end{enumerate}
