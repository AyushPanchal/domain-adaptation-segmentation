...
The configuration files under \texttt{configs/experiments/} define the initial experiment set. Later Kaggle notebooks extend the same implementation pattern for additional supervised, large-model, high-resolution, and ensemble experiments.
