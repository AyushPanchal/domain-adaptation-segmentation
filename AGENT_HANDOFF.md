...
2. Submit E01-E06 as single jobs with `CONDA_ENV=domainseg YOLO_DEVICE=0 YOLO_BATCH=2 YOLO_WORKERS=2 EXPERIMENT_CONFIG=<config> sbatch --exclude=node1 scripts/remote/slurm_single_experiment.sbatch`.
